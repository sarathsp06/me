...
### Day 1 — Sat 23 May: Rotterdam → Triberg / Black Forest (~5h)

Depart Rotterdam morning (~8 AM). Drive south via A3/A61/A5/B33 into the Black Forest. Arrive Triberg area by early-mid afternoon.

**Anchor:** Triberg Waterfalls — Germany's highest (163m over 7 stages).
**Skippable:** Full upper trail (the lower falls are the most dramatic).
**Low-energy fallback:** Flat accessible path from the Asklepios Klinik entrance to the first viewing platform.

**Rest stops:** Raststätte Montabaur (A3, ~2h in) — playground, baby-change. Raststätte Baden-Baden (A5, ~4h in) — playground, green area. Plan at least two rest stops on this leg.

> **Tip:** Saturday means shops are open. Stock up on essentials at a DM/Rossmann en route (motorway service area near the A5) or in Triberg before shops close (~8 PM). Tomorrow (Sunday) shops are closed.

**In Triberg (afternoon/evening):**
- **Triberg Waterfalls** — the Gutach river cascading 163m over 7 stages through dense Black Forest. Three marked routes: Naturweg, Kulturweg, Kaskadenweg.
- **Trail time:** 45-90min depending on route.
- **Stroller:** NOT possible on the main trails (natural, uneven paths). Use baby carrier for the full trail. There IS a wheelchair-accessible flat path from the **Asklepios Klinik entrance** (Ludwigstraße 1) to the first viewing platform — works for stroller/senior.
- **Senior-friendly:** The accessible route from Asklepios entrance gives views of the lower falls without stairs. The full trail has steps and uneven ground.
- **Squirrels!** — tame squirrels along the paths. The 5-year-old will love them. Bring nuts.
- **Illuminated until ~10 PM** in summer — evening visit is magical if the kids are still awake.
- Check into accommodation in Triberg or nearby (Gasthaus/hotel, ~€80-130/night).
- Dinner at a traditional Black Forest Gasthaus. Try Schwarzwälder Kirschtorte (Black Forest cake) — you're at the source.

**Cost:** Adults €9, children 6-17 €8.50, under 6 free. Family ticket (2 adults + kids) €20. Includes Schwarzwaldmuseum entry.

> **Tip:** The lower falls near the main entrance are the most impressive and easiest to reach. If the senior can only do one section, the accessible path from the Asklepios entrance to the first platform is the right choice — dramatic views, no stairs.
...
- **Drive Triberg → Rhine Falls (Schaffhausen): ~1h30.**
- **Europe's largest waterfall by volume.** 23m high × 150m wide. Average flow in late May: ~600 m³/s (snowmelt peak!). Not tall but enormously powerful — the ground shakes.
- **Arrive ~11:00 AM. Allow 1.5-2h.**
- **Two sides:**
  - **North side (Neuhausen/Schlössli Wörth):** FREE entry. Flat basin area. Elevator from railway station. Best panoramic views. **Stroller-friendly. Senior-friendly.** Start here.
  - **South side (Schloss Laufen):** CHF 5/adult, under 6 free. Closer platforms including the dramatic Fischetz platform — but involves steep stairs. Not stroller-accessible to the lower platforms. The Belvedere deck (upper level) is accessible by panoramic lift.
- **Boat ride to the central rock:** ~CHF 10-20/adult. Thrilling but assess for baby comfort (spray, noise). The 5-year-old will love it.
- **Recommendation for your group:** Do the north side (free, flat, accessible). If energy allows, cross to the south side for the Belvedere deck (lift-accessible). Skip the lower stairs on the south side with the senior.

**Cost:** North side free. South side CHF 5/adult, under 6 free. Boat rides CHF 10-20/adult.

> **Note:** Tickets for visitors with prams are only available at the Visitor Centre (not online).
...
- **Access by tunnel lift** inside the rock — then walk between galleries via tunnels and walkways.
- **Stroller:** NOT possible (narrow tunnels, stairs, wet surfaces). **Baby carrier only.**
- **Senior assessment:** Moderate to demanding. There are stairs between galleries. The lift eliminates the main climb, but walking between the 10 falls involves uneven, wet surfaces and some steep sections. A fit senior can do galleries 1-6 (the most impressive) and skip the upper ones.
- **5-year-old:** Will be awestruck — waterfalls thundering inside a mountain, spray everywhere, dramatic lighting. Hold their hand on wet surfaces.
...
**Midday — Staubbach Falls + Lauterbrunnen Village:**
- **297m free-falling waterfall** — one of the highest free-falling waterfalls in Europe. Visible from the entire Lauterbrunnen village. The mist drifts across the valley.
- **Completely free.** Just walk into the village and look up.
- **Short trail to the base** — 10min walk from the village centre, flat and easy.
- **Trail behind the falls** — carved into the rock, gives you a view from behind the curtain of water. May be closed early season (check locally). Moderate — some steps.
- **Senior-friendly:** The village viewpoint requires zero effort. The base trail is easy. The behind-the-falls trail has steps.
- **Photography:** Best light in the morning when the sun hits the falls. But dramatic in any light — the sheer scale is the point.
- **Lunch** in Lauterbrunnen village. Small, car-free centre with cafés and restaurants.

**Cost:** Free.

**Afternoon option — Interlaken walk:**
- 10min drive from Lauterbrunnen to Interlaken.
- Walk the **Höheweg** (main promenade) between the two lakes (Thun and Brienz). Flat, stroller-friendly. Views of the Jungfrau massif.
...
**Low-energy fallback:** Rhine promenade flat walk only.

> **🛒 Back in Germany** — affordable baby supplies again. Stop at a supermarket en route or in the Königswinter/Bonn area.

**Rest stops:** Raststätte Wutachtal (A81, ~1.5h in) and Raststätte Montabaur (A3, ~3h in) — both have playgrounds and baby-change.

**In Königswinter (afternoon/evening):**
- **Drachenfels cogwheel railway** — Germany's oldest cog railway. Short ride to the castle ruin with Rhine valley views. A nice bookend to the trip. ~€14/adult return, kids discounted.
- **Rhine promenade** — flat riverside walk. Stroller-friendly. Views of the Siebengebirge (Seven Mountains).
...
**Low-energy fallback:** Drive straight through.

**Rest stop:** Raststätte Köln-Eifeltor or Frechen (A1/A4 area, ~45min in) — playground, baby-change.

Trip complete. Full afternoon + evening to recover. Unpack, laundry, collapse.
...
Late May is late spring, not winter. Mountain summits need layers, not winter gear.
...
- 1 large soft bag + 1 medium bag for clothing (5 people, 8 days)
- 1 small bag for baby supplies (nappies, wipes, changes) — accessible in cabin
- Compact folding stroller — in boot
- Baby carrier — in cabin
- Snack bag + cooler bag in cabin
- Rain jackets + fleece layers — in cabin
- Cash: EUR + CHF (some Swiss parking/mountain huts are cash-only)

**Rear seat:** 2 child seats (rear-facing for 1yo, forward-facing for 5yo) + 1 adult in middle.
...
- [ ] Car check — tyres, oil, coolant, washer fluid
